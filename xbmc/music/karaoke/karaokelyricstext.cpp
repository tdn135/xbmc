...
bool CKaraokeLyricsText::InitGraphics()
{
  ...
  CStdString fontPath = URIUtils::AddFileToFolder("special://home/media/Fonts/", g_guiSettings.GetString("karaoke.font"));
  if (!XFILE::CFile::Exists(fontPath))
      fontPath = URIUtils::AddFileToFolder("special://xbmc/media/Fonts/", g_guiSettings.GetString("karaoke.font"));
